...
uint256 hashGenesisBlock("0x8a1526dbe6de0928716c2dd2edb7a49c974bbd24fb89b6e76333561db37fa82e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TopCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TopCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if (nSubsidy < nMinSubsidy)
    {
		...
		if(rand > 7890 && rand < 7901)			// 1/2880
			nSubsidy = 100 * nMinSubsidy;
		else if(rand > 15000 && rand < 15241)	// 1/120
			nSubsidy = 10 * nMinSubsidy;
    }
...
static const int64 nTargetTimespan = 30 * 30;						// TopCoin: every 15 minutes
static const int64 nTargetSpacing = 30;								// TopCoin: 30 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal topcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TopCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jan 27, 2014: The BitInstant CEO and a Florida man are accused of selling more than $1 million worth of bitcoins to people trying to buy and sell illegal drugs on the Silk Road website.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("046f9976243195631fb9871b64a6745d297c77ad2dd657053f1182cfdc32378cdc24700151a31f1bfdd0381ac624fdcc83cb481368dda02ef493dab817adcff8f7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1390963784;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 13690369;

		if (fTestNet)
        {
            block.nTime    = 1390000000;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x132392dbd1ec4d6ebc979870014ba57a9abf1a2f9da52b6ffbf280b7f094df70"));
...
unsigned char pchMessageStart[4] = { 0xc1, 0xdb, 0xf0, 0xfd }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // TopCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
