...
static const int64 MAX_MONEY = 13000000000 * COIN; // TopCoin: maximum of 13.0 billion coins
static const int64 TOTAL_GENERATION = MAX_MONEY;
static const double SERVICE_TAX_PERCENTAGE = 0.00;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // TopCoin: 2880 blocks found a day. Priority cutoff is 1 topcoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("046f9976243195631fb9871b64a6745d297c77ad2dd657053f1182cfdc32378cdc24700151a31f1bfdd0381ac624fdcc83cb481368dda02ef493dab817adcff8f7")))
